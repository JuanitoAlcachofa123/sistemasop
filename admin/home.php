...
<div class="containe-fluid">
	...
	<div class="row mt-3 ml-3 mr-3 mb-2">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					<?php echo "Bienvenido señor ".$_SESSION['login_name']."!"  ?>
	...
	<div class="row m-3">
			...
			<div class="card rounded-0 shadow">
				<div class="card-body">
					<div class="container-fluid">
						<h5 class="tex-muted">Menú total Activo</h5>
						<?php 
		...
		<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 mb-3">
			<div class="card rounded-0 shadow">
				<div class="card-body">
					<div class="container-fluid">
						<h5 class="tex-muted">Menú Total Inactivo</h5>
						<?php 
		...
		<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 mb-3">
			<div class="card rounded-0 shadow">
				<div class="card-body">
					<div class="container-fluid">
						<h5 class="tex-muted">Ordenes de Verificación</h5>
						<?php 
		...
		<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 mb-3">
			<div class="card rounded-0 shadow">
				<div class="card-body">
					<div class="container-fluid">
						<h5 class="tex-muted">Pedidos Confirmados</h5>
						<?php 
